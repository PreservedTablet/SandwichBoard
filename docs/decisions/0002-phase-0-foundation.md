...
| STOP                   | Disposition                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| ---------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Repo settings via `gh` | No `gh`/admin API in the build session. Exact commands handed to the maintainer in the session log; criterion recorded as **pending maintainer execution**, not silently degraded. One item verified empirically anyway: an org-level ruleset already enforces secret-scanning push protection (a push containing provider-pattern fakes was rejected with GH013), though repo-level Secret Scanning alert management still needs the settings toggle. |
